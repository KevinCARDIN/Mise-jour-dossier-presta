...
st.write("Merci de bien vouloir nous transmettre les informations suivantes (les champs marqués d'une * sont obligatoires) :")
...
if st.button("Soumettre la mise à jour du dossier"):
    ...
    if not st.session_state.get('villes_finales'): erreurs.append("Vous devez calculer et sélectionner au moins une ville d'intervention.")
